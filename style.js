class Movie {
    constructor() {
      ...
      this.actors.hatConfettiRight = this.actors.hatConfettiGroup.querySelectorAll(
        "#hat-confetti circle.right"
      );
      this.actors.balloonConfetti = document.querySelector("#balloon-confetti");
      this.actors.balloonConfettiLeft = this.actors.balloonConfetti.querySelectorAll(
        "#balloon-confetti circle.left"
      );
      this.actors.balloonConfettiRight = this.actors.balloonConfetti.querySelectorAll(
        "#balloon-confetti circle.right"
      );
      this.actors.gopher = document.querySelector("#gopher");
      this.actors.gopherRightEye = this.actors.gopher.querySelector(
        "#go-right-eye"
      );
      this.actors.gopherLeftEye = this.actors.gopher.querySelector(
        "#go-left-eye"
      );
      this.actors.gopherLeftHand = this.actors.gopher.querySelector(
        "#go-left-hand"
      );
      this.actors.gopherEyeBlinks = this.actors.gopher.querySelectorAll(
        ".eye-blink"
      );
  ...
  movie.actors.greeting.addEventListener("click", function (evt) {
    window.open("https://www.facebook.com/profile.php?id=100024621786944");
  });
